    ...
    $.extend($.apusThemeCore, {
        ...
        listing_init: function() {
            ...
            if ($('#apus-listing-map').length) {
                L.Icon.Default.imagePath = 'wp-content/themes/findus/images/index.html';
            }
        ...
        mapInit: function() {
            ...
            if ( findus_listing_opts.mapbox_token != '' ) {
                var tileLayer = L.tileLayer('../../../api.tiles.mapbox.com/v4/%7bid%7d/%7bz%7d/%7bx%7d/%7by%7dafd4.json?access_token={accessToken}', {
